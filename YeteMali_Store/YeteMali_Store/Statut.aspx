<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Statut.aspx.cs" Inherits="YeteMali_Store.Statut" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="principal" runat="server">
    <div class="page-content">
      ...
      <div class="page-header">
           <h1> Portail Statut > Enregistrement </h1>                   
      </div><!-- /.page-header -->
          ...
          <asp:Label ID="message" runat="server" Text=""></asp:Label>
                ...
                <div class="form-group">
                      ...
                      <asp:TextBox ID="txtStatut" runat="server" CssClass="form-control col-md-12" placeholder="Nom du Service"></asp:TextBox>    
               </div>
         ...
         <asp:GridView ID="gridStatut" runat="server" CssClass=" table col-md-12" AutoGenerateColumns="False" CellPadding="6" ForeColor="#333333" GridLines="None" Font-Size="13pt">
             <AlternatingRowStyle BackColor="White" />
             <Columns>
                 <asp:BoundField DataField="id_statut" HeaderText="Code Statut" />
                 <asp:BoundField DataField="situation" HeaderText="Attribution" />
